...
createRoot(document.getElementById('root')).render(
  <StrictMode>
    ...
    <Routes>
      ...
      <Route path='/Product_list' element={<UserProtectedWrapper><Product_list/></UserProtectedWrapper>}/>
      <Route path='/Product_detail' element={<UserProtectedWrapper><Product_detail/></UserProtectedWrapper>}/>
      ...
      <Route path='product_add' element={<UserProtectedWrapper><Addproduct/></UserProtectedWrapper>}/>
      <Route path='product_update/:id' element={<UserProtectedWrapper><Update_product/></UserProtectedWrapper>}/>
      <Route path='product_view' element={<UserProtectedWrapper><View_product/></UserProtectedWrapper>}/>
      </Route>
    </Routes>
    </BrowserRouter>
    </ProductContext>
